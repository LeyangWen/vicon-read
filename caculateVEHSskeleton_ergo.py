...
if __name__ == '__main__':
    ...
    cdf_output = True
    skeleton_config = r'config\VEHS_ErgoSkeleton_info\Ergo-Skeleton-66.yaml'
    if cdf_output:
        ...
        custom_6D_kpts_of_interest = [RPSIS, RASIS, LPSIS, LASIS, C7_d, SS, T8, XP, C7, HDTP, MDFH, REAR, LEAR, RAP, RAP_f, RLE, RAP_b, RME, LAP, LAP_f, LLE,
                                 LAP_b, LME, LUS, LRS, RUS, RRS, RMCP5, RMCP2, LMCP5, LMCP2, LGT, LMFC, LLFC, RGT, RMFC, RLFC, RMM, RLM, LMM, LLM, LMTP1, LMTP5, LHEEL,
        ...
        custom_6D_joint_names = ['RPSIS', 'RASIS', 'LPSIS', 'LASIS', 'C7_d', 'SS', 'T8', 'XP', 'C7', 'HDTP', 'MDFH', 'REAR', 'LEAR', 'RAP', 'RAP_f', 'RLE', 'RAP_b', 'RME', 'LAP', 'LAP_f', 'LLE',
                                 'LAP_b', 'LME', 'LUS', 'LRS', 'RUS', 'RRS', 'RMCP5', 'RMCP2', 'LMCP5', 'LMCP2', 'LGT', 'LMFC', 'LLFC', 'RGT', 'RMFC', 'RLFC', 'RMM', 'RLM', 'LMM', 'LLM', 'LMTP1', 'LMTP5', 'LHEEL',
                                 'RMTP1', 'RMTP5', 'RHEEL', 'HEAD', 'RSHOULDER', 'LSHOULDER', 'THORAX', 'LELBOW', 'RELBOW', 'RWRIST', 'LWRIST', 'RHAND', 'LHAND', 'PELVIS', 'RHIP', 'RKNEE',
                                 'RANKLE', 'RFOOT', 'LHIP', 'LKNEE', 'LANKLE', 'LFOOT']
        kpts_of_interest = custom_6D_kpts_of_interest
        kpt_names = custom_6D_joint_names
        ...
        frame_output_dir = os.path.join(trial_name[0], 'render', 'frame_output_66', activity_name)
        ...
        world3D_skeleton = VEHSErgoSkeleton(skeleton_config)
        ...
        # world3D_skeleton.plot_3d_pose_frame(frame=0, filename=False, range=1000, coord_system="world")

        for cam_idx, camera in enumerate(cameras):
            print(f'Processing camera {cam_idx}: {camera.DEVICEID}')
            # if camera.DEVICEID != '66920758':
            #     continue
            ...
            world2D_skeleton = VEHSErgoSkeleton(skeleton_config)
...
# #todo: back vector change to C7_m - PELVIS
#
#     ######################################## Calculate angles ########################################
#     caculate_angles = True
#     if caculate_angles:
#
