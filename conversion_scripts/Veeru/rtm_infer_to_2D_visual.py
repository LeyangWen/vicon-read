...
def phrase_args():
    ...
    parser.add_argument('--RTM_infer_folder', type=str, default='/Volumes/Z/RTMPose/37kpts_rtmw_v4/Ricks_Videos_RTMW_freeze_backbone_neck_merged_epoch_best')
    parser.add_argument('--base_frame_folder', type=str, default='/Volumes/Z/RTMPose/inference_vid/Industry/5fps')
